...
func TestSettingsWarnings(t *testing.T) {
	...
	// A password a provider will not use.
	assert.NotEmpty(t, dbcreds.Settings{Enabled: true, ProviderName: "aws-iam", Password: "hunter2"}.IgnoredPasswordWarning())
	assert.Empty(t, dbcreds.Settings{Enabled: true, ProviderName: dbcreds.StaticProviderName, Password: "hunter2"}.IgnoredPasswordWarning(),
		"the static provider does use the password")
	assert.Empty(t, dbcreds.Settings{Password: "hunter2"}.IgnoredPasswordWarning())
}
